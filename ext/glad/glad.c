/*
    ...
    OpenGL loader generated by glad 0.1.36 on Fri Jun 19 05:27:56 2026.
...
static void load_GL_MESA_map_buffer_client_pointer(GLADloadproc load) {
	if(!GLAD_GL_MESA_map_buffer_client_pointer) return;
	glad_glAddClientPointerRangeMESA = (PFNGLADDCLIENTPOINTERRANGEMESAPROC)load("glAddClientPointerRangeMESA");
	glad_glReleaseClientPointerRangeMESA = (PFNGLRELEASECLIENTPOINTERRANGEMESAPROC)load("glReleaseClientPointerRangeMESA");
}
...
static int find_extensionsGL(void) {
	...
	GLAD_GL_MESA_map_buffer_client_pointer = has_ext("GL_MESA_map_buffer_client_pointer");
...
int gladLoadGLLoader(GLADloadproc load) {
	...
	load_GL_MESA_map_buffer_client_pointer(load);
