...
GLAPI int GLAD_GL_MESA_map_buffer_client_pointer;
typedef void (APIENTRYP PFNGLADDCLIENTPOINTERRANGEMESAPROC)(void *addr, GLsizeiptr size);
GLAPI PFNGLADDCLIENTPOINTERRANGEMESAPROC glad_glAddClientPointerRangeMESA;
#define glAddClientPointerRangeMESA glad_glAddClientPointerRangeMESA
typedef void* (APIENTRYP PFNGLRELEASECLIENTPOINTERRANGEMESAPROC)(GLsizeiptr *size);
GLAPI PFNGLRELEASECLIENTPOINTERRANGEMESAPROC glad_glReleaseClientPointerRangeMESA;
#define glReleaseClientPointerRangeMESA glad_glReleaseClientPointerRangeMESA
#endif
